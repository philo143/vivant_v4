...
class CreateMmsRegionalSummaryHapsTable extends Migration
{
    /**
     * Run the migrations.
     *
   ...
   public function up()
    {
        Schema::create('mms_regional_summary_hap', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
         Schema::dropIfExists('mms_regional_summary_hap');
    }
}
