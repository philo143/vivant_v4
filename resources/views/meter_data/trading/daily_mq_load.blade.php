...
@section('scripts')
   ...
   $.extend({
   		displayData : function(){
   			...
   			var customers = ['Customer 1','Customer 2'];
   			var seins = ['SEIN001','SEIN002'];

   			html+='<tr>';
   			html+='<td colspan="2">Customer</td>';
   			$.each( customers, function( ii, customer ) {
   				html+='<td style="min-width:90px;">'+customer+'</td>';
   			});
   			html+='</tr>';
   			...
   			$.each( seins, function( ii, sein ) {
   				html+='<td style="min-width:90px;">'+sein+'</td>';
   			});
   			html+='</tr>';
