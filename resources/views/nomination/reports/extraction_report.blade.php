...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-2">
         ...
         <div class="col-md-10">
         	{!! Breadcrumbs::render('extraction_nomination') !!}
			@include ('user.message')
			<h4>Nomination Extraction Report</h4>
			...
			<div class="well bs-component col-md-12">
				...
				<div class="form-group">
					<div class="col-lg-2" style="text-align: right;">
						<input type="checkbox" name="chk_all_buyers" id="chk_all_buyers"><span class="control-label">&nbsp;All Buyers :</span>
					</div>
					<div class="col-lg-2">
				...
				<div class="form-group">
					...
					<div class="col-lg-3" id="result_button"></div>
				</div>
				{{ Form::close() }}
	         </div> <!-- end -->
...
$(document).ready(function(){
	...
	$.extend({
		retrieve : function(){
            ...
            if ( $('input[name="chk_all_buyers"]:checked').length > 0 ) {
	    		customer_id = '';
	    	}
			...
			$('#result_button').html('');
			$.ajax({
                url : "/nomination/extraction_report/data",
                ...
                success : function(data){
                	...
                	if (total_records > 0) {
				    	...
				    	var buttons = '<button class="btn btn-success btn-sm" type="button" id="btn_excel" style="margin-right:8px;">Export to Excel</button>&nbsp;';
				    	buttons += '<button class="btn btn-success btn-sm" type="button" id="btn_csv">Export to CSV</button>&nbsp;';
        ...
        downloadFile :function(file_format){
            ...
            if (errors.length > 0 ) {
	            ...
	            window.location.href = '/nomination/extraction_report/file'+params;
            }
    ...
    $('#chk_all_buyers').unbind().bind('click',function(){
