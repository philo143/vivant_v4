...
@section('content')
	<div class="container-fluid">
	    <div class="row">
	        ...
	        <div class="col-md-10">
	            <legend>Day Ahead Offer Reserve</legend>
	            @php
                $form_data = array();
	            	...
	            	{{ Form::open(['class'=>'form-horizontal','id' => 'form_retrieve']) }}
						...
						<div class="row">
			            	<div class="form-group col-md-5">
								...
								<div class="col-lg-6"> 
									{{ Form::select('reserve_class', ['REG'=>'REGULATION','CON'=>'CONTINGENCY','DIS'=>'DISPATCH','ILD'=>'INTERRUPTIBLE LOAD'],isset($form_data['reserve_class']) ? $form_data['reserve_class'] : 'DIS', ['class'=>'form-control input-sm']) }}														
								</div>
							</div>
						</div>
	            		<div class="row">
			            	<div class="form-group col-md-5">
								...
								<div class="col-lg-6"> 
									{{ Form::select('action', ['submit'=>'SUBMIT','cancel'=>'CANCEL'], $form_data['action'],['class'=>'form-control input-sm']) }}
								</div>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-md-5"> 							
								...
								<div class="col-lg-6">
									<div class="input-group">
										{{ Form::text('unit',isset($form_data['resource_id']) ? $form_data['resource_id'] : '', ['class'=>'form-control input-sm','readonly'=>'readonly','required'=>'required']) }}
						...
						<div class="row">
							<div class="form-group col-md-5"> 
							    ...
							    <div class="col-lg-4">
							    	{{ Form::text('opres_ramp_rate',isset($form_data['opres_ramp_rate']) ? $form_data['opres_ramp_rate'] : '',['class'=>'form-control input-sm']) }}
							    </div>
							</div>
						</div>
						<div class="row">
	            ...
	            <div class="well col-md-12">
			      	<h5>Upload Day Ahead Reserve Offer Template &nbsp;&nbsp;
					...
					<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					      <div class="panel-body">
					        ...
					        {{ Form::hidden('template_type','da_reserve')}}
