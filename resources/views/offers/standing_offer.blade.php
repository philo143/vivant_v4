...
@section('content')
	<div class="container-fluid">
	    <div class="row">
	        ...
	        <div class="col-md-10">
	            <legend>Standing Bids and Offers</legend>
	            @php
                $form_data = array();
	            ...
	            <div class="well col-md-12">
			      	<h5>Upload Standing Offer Template &nbsp;&nbsp;
					...
					<div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
					      <div class="panel-body">
					        ...
					        {{ Form::hidden('template_type','standing')}}
	    ...
	    $.extend({
			...
			determineDisabled : function(){
	            ...
	            if (date_selected > current_date) {
	                ...
	                $('.price_qty').attr('disabled','disabled')
	                $('.ramp_rate').attr('disabled','disabled')
