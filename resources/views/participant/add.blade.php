...
@section('content')
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-10">
				{!! Breadcrumbs::render('participant.add') !!}
            	@if ( count($errors) )
				...
				{{ Form::open(['route' => 'participants.store', 'method'=>'post', 'class'=>'form-horizontal', 'files'=>true]) }}
				<legend>Add Participant</legend>
				<div class="form-group"> 
					{{ Form::label('participant_name', 'Participant Name:', ['class'=>'col-lg-2 control-label']) }}
					<div class="col-lg-10"> 
						{{ Form::text('participant_name', '', ['class'=>'form-control input-sm', 'placeholder'=>'Participant Name', 'required'=>'required']) }}
					</div>
				</div>
				<div class="form-group"> 
				...
				<div class="form-group"> 
					...
					<div class="col-lg-4"> 
						{{ Form::text('cert_user', '', ['class'=>'form-control input-sm', 'placeholder'=>'Cert Username']) }}
					</div>
				</div>
				<div class="form-group"> 
				...
				<div class="form-group">
					<div class="col-lg-10 col-lg-offset-2">
						{{ Form::submit('Add Participant', ['class'=>'btn btn-primary btn-sm']) }}
					</div>
				</div>
				{{ Form::close() }}
				</div>
